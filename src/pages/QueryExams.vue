    ...
    <div class="page-container">
      ...
      <div class="results-container">
        ...
        <table class="results-table">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <router-link :to="{ name: 'HomeAdmin', params: { id: index } }">editar</router-link>
                    </div>
                    <div v-else>
                    <router-link :to="{ name: 'QueryResults', params: { id: index } }">resultado</router-link>
                    </div>
                </td>
                </tr>
            </tbody>
        ...
        <div v-if="tableData.length > 10" class="pagination-controls flex justify-end mt-4">
          <button v-if="currentPage > 1" @click="goToPreviousPage" class="pagination-button">
            Anterior
          </button>
          <span class="pagination-info">Página {{ currentPage }} de {{ totalPages }}</span>
          <button v-if="currentPage < totalPages" @click="goToNextPage" class="pagination-button">
            Próxima
          </button>
        </div>
      </div>
